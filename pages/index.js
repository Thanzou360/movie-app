      ...
      {loading ? <loading /> : <div className="container">
        <div className="topheadertitle flex flex-sb">
          ...
          <div>
            ...
            <p className="mb-2 w-66">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum est nihil aliquam vel vitae sapiente, quam aliquid itaque molestias aspernatur repellat sequi accusamus
              natus expedita, suscipit perspiciatis nobis quae! Natus?
            </p>
            <Link href="/"><button>Exclusive On <span>Stream360</span></button></Link>
          </div>
        ...
        <div className="fourcards flex flex-sb">
          ...
          <div className="moviecards flex flex-col flex-left gap-2 w-100">
            ...
            <Link href='/movies'className="loadmorehomebtn w-100 flex flex-center
            mt-2"><button>Load more</button></Link>
          </div>
